...
export interface paths {
    ...
    "/forges": {
        ...
        post: {
            ...
            requestBody: {
                content: {
                    "*/*": components["schemas"]["ForgeWithOAuthClientSecret"];
                };
            };
            responses: {
                /** @description OK */
    ...
    "/orgs/{org_id}/agents/{agent_id}": {
        ...
        put?: never;
        post?: never;
        /** Delete an organization-scoped agent */
        delete: {
            parameters: {
                query?: never;
                header: {
    ...
    "/orgs/{org_id}/secrets/{secret}": {
        ...
        patch: {
            ...
            requestBody: {
                content: {
                    "*/*": components["schemas"]["SecretPatch"];
                };
            };
            responses: {
                /** @description OK */
    ...
    "/repos/{repo_id}/logs/{pipeline_number}/{step_id}/download": {
        ...
        /** Download logs for a pipeline step */
        get: {
            parameters: {
                query?: never;
                header: {
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["metadata.Metadata"];
                    };
                };
            };
        };
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["RepoLastPipeline"][];
                    };
                };
            };
        };
...
export interface components {
    schemas: {
        ...
        Pipeline: {
            ...
            author_email?: string;
            branch?: string;
            cancel_info?: components["schemas"]["CancelInfo"];
            ...
            deploy_task?: string;
            deploy_to?: string;
            errors?: components["schemas"]["errors.PipelineError"][];
            event?: components["schemas"]["WebhookEvent"];
            event_reason?: string[];
            finished?: number;
            forge_url?: string;
        ...
        QueueInfo: {
            paused?: boolean;
            pending?: components["schemas"]["model.QueueTask"][];
            running?: components["schemas"]["model.QueueTask"][];
            stats?: {
            ...
            waiting_on_deps?: components["schemas"]["model.QueueTask"][];
        };
        Registry: {
            address?: string;
            id?: number;
        ...
        Repo: {
            ...
            require_approval?: components["schemas"]["model.ApprovalMode"];
            secret_extension_endpoint?: string;
            secret_extension_netrc?: boolean;
            timeout?: number;
            trusted?: components["schemas"]["model.TrustedConfiguration"];
        ...
        RepoLastPipeline: {
            ...
            has_no_forge_repo?: boolean;
            id?: number;
            last_pipeline?: components["schemas"]["Pipeline"];
            name?: string;
            netrc_trusted?: string[];
            org_id?: number;
            owner?: string;
        ...
        RepoPatch: {
            ...
            secret_extension_netrc?: boolean;
            timeout?: number;
            trusted?: components["schemas"]["model.TrustedConfigurationPatch"];
            visibility?: string;
        };
        /** @enum {string} */
        ...
        /** @enum {string} */
        StatusValue: "skipped" | "pending" | "running" | "success" | "failure" | "killed" | "canceled" | "error" | "blocked" | "declined" | "created";
        Step: {
            error?: string;
            exit_code?: number;
            finished?: number;
        ...
        Task: {
            ...
            created?: number;
            dep_status?: {
                [key: string]: components["schemas"]["StatusValue"];
            };
            dependencies?: string[];
            id?: string;
            labels?: {
        ...
        /** @enum {string} */
        WebhookEvent: "push" | "pull_request" | "pull_request_closed" | "pull_request_metadata" | "tag" | "release" | "deployment" | "cron" | "manual";
        "errors.PipelineError": {
            data?: unknown;
            is_warning?: boolean;
            message?: string;
            type?: components["schemas"]["errors.PipelineErrorType"];
        };
        /** @enum {string} */
        "errors.PipelineErrorType": "linter" | "deprecation" | "compiler" | "generic" | "bad_habit";
        "metadata.Author": {
            email?: string;
            name?: string;
        };
        "metadata.Commit": {
            author?: components["schemas"]["metadata.Author"];
            branch?: string;
            changed_files?: string[];
            draft?: boolean;
            labels?: string[];
        ...
        /** @enum {string} */
        "metadata.Event": "push" | "pull_request" | "pull_request_closed" | "pull_request_metadata" | "tag" | "release" | "deployment" | "cron" | "manual";
        "metadata.Forge": {
            type?: string;
            url?: string;
        };
        "metadata.Metadata": {
            curr?: components["schemas"]["metadata.Pipeline"];
            forge?: components["schemas"]["metadata.Forge"];
            id?: string;
            prev?: components["schemas"]["metadata.Pipeline"];
            repo?: components["schemas"]["metadata.Repo"];
            step?: components["schemas"]["metadata.Step"];
            sys?: components["schemas"]["metadata.System"];
            workflow?: components["schemas"]["metadata.Workflow"];
        };
        "metadata.Pipeline": {
            author?: string;
            avatar?: string;
            commit?: components["schemas"]["metadata.Commit"];
            created?: number;
            cron?: string;
            event?: components["schemas"]["metadata.Event"];
            event_reason?: string[];
            finished?: number;
            forge_url?: string;
            number?: number;
            parent?: number;
            release?: components["schemas"]["metadata.Release"];
            rerun_count?: number;
            started?: number;
            status?: string;
            target?: string;
        ...
        "metadata.Repo": {
            ...
            private?: boolean;
            remote_id?: string;
            trusted?: components["schemas"]["metadata.TrustedConfiguration"];
        };
        "metadata.Step": {
            name?: string;
            number?: number;
        ...
        /** @enum {string} */
        "model.ApprovalMode": "none" | "forks" | "pull_requests" | "all_events";
        /** @enum {string} */
